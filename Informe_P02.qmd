...
\newpage 
## Metodología
Para esta práctica de inferencia y contrastes de hipótesis, utilizaremos en todo momento el conjunto de datos al completo, es decir, los 250 individuos (dado que eliminamos los 15 con origen desconocido), en lugar de seleccionar una muestra aleatoria en lugar de como se hizo en la práctica 1

\newpage
## Análisis de resultados
### Pregunta 1. ¿Entre qué valores fluctúa el promedio de la anchura de la cabeza y de la longitud de los élitros del Lacanus Cervus?
...
\\\\
Para ello hacemos un test t de de Student sobre la muestra de los machos y la muestra de las hembras. Concretamente haremos una prueba t de Welch, que se usa con dos muestras independientes cuando las varianzas no son iguales. Además, conviene su uso al ser las dos muestras de diferentes tamaños.
