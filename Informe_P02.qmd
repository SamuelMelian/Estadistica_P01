...
tabla_prop <- data.frame(
  Estadístico = paste0("Chi-cuadrado = ", round(ic_habitat$statistic, 3)),
...
knitr::kable(
  tabla_prop,
  caption = "Contraste de proporciones entre Asturias y Cantabria con IC 95%",
  booktabs = TRUE,
  align = "c"
)
...
knitr::kable(
  tabla_prop,
  caption = "Contraste de proporciones según sexo con IC 95%",
  booktabs = TRUE,
  align = "c"
)
