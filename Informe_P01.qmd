...
A continuación, el análisis por sexos nos ha permitido comprobar la existencia de un claro dimorfismo sexual. Los machos presentan una anchura de la cabeza media de $14,91$ mm, lo que resulta casi $5$ mm más que el promedio de las hembras de la muestra. Además, la variabilidad en los machos es aproximadamente el triple que en las hembras, mostrando estas últimas valores bastante concentrados en torno a la media como se puede comprobar en la respectiva caja del diagrama. Estas conclusiones han sido posibles gracias a estadísticos descriptivos y diagramas de caja.
