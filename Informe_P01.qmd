...
Como hemos mencionado, el siguiente estudio se basa en un análisis estadístico descriptivo de datos biométricos del ciervo volante (Lucanus cervus). En concreto, en relación a patrones de variación morfológica por sexo y por procedencia de los individuos.
...
Esto permitirá llevar a cabo una comparación entre machos y hembras, así como un estudio en función del hábitat. A través de las tablas y gráficos adecuados, se buscará observar diferencias según las variables, así como dispersión y valores atípicos.
...
**Interpretación:** La correlación es fuerte al ser la r positiva cerca de $1$. Además, el valor de $R^2$ muestra que un $75,6$% de la variabilidad de la variable KB (anchura de la cabeza) se explica en función de los valores de la otra, EL (longitud de los élitros), de nuevo reiterando la relación entre ellas.
...
**Interpretación:** la correlación es muy fuerte tanto en el caso de las hembras como en el de los machos, y se observa una mejora considerable al separarlo por sexos.
...
$R^2 \approx 0.9089$, lo que nos hace ver que el modelo se ajusta muy bien. El análisis de las gráficas de diagnóstico también confirma la adecuación del ajuste del modelo lineal en este caso.

\newpage

## Conclusiones
En este análisis estadístico se ha realizado un análisis descriptivo de datos biométricos del ciervo volante (\textit{Lucanus cervus}) a partir de una muestra aleatoria de 150 individuos. El estudio en su totalidad se ha centrado en el análisis de la anchura de la cabeza, su variabilidad en función del sexo y procedencia geográfica y la relación con la longitud de los élitros.
